...
class JointPositionControlNode:
    def __init__(self):
        ...
        rospy.Subscriber("/gripper/kinematics_pose", KinematicsPose, self.current_position_callback)
        rospy.Subscriber("/joint_states",JointState,self.joint_state_callback)

    def joint_state_callback(self,data):
        self.current_angles=list(data.position[1:]) # different in simulation 
